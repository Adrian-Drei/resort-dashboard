...
<template>
  <div>
    <h1 class="text-xl font-bold mb-4">Room Types</h1>
    <ul>
      <li v-for="t in roomTypes" :key="t.id" class="flex items-center gap-2">
        {{ t.name }} - ₱{{ t.price }}
        <button class="text-red-500" @click="removeRoomType(t.id)">x</button>
      </li>
    </ul>
